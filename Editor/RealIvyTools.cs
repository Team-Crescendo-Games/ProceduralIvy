...
namespace TeamCrescendo.ProceduralIvy
{
    public class RealIvyTools : EditorWindow
    {
        ...
        private void DrawGUI(SceneView sceneView)
        {
            ...
            if (GUI.Button(togglevisibilityButton, Constants.TOOL_TOGGLEPANEL_GUICONTENT,
            ...
            if (toolsShown)
            {
                ...
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_PAINT_GUICONTENT,
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_MOVE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_SMOOTH_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_REFINE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_OPTIMIZE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_CUT_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_ADDLEAVE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_SHAVE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
                ...
                XSpace += 44f;
                if (GUI.Button(new Rect(XSpace, 56f, 36f, 36f), Constants.TOOL_DELETE_GUICONTENT,
                        windowSkin.GetStyle("sceneviewbutton")))
                {
        ...
        {
            if (toolMode != ToolMode.None || RealIvyWindow.instance.placingSeed ||
